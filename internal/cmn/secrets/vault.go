...
func (r *vaultResolver) Validate(ref ir.SecretRef) error {
...
func (r *vaultResolver) CheckCapability(ir.SecretRef) CheckCapability {
	return CheckCapabilityRequiresValueRead
}

// Resolve fetches the secret value from HashiCorp Vault.
func (r *vaultResolver) Resolve(ctx context.Context, ref ir.SecretRef) (string, error) {
...
func (r *vaultResolver) CheckAccessibility(ctx context.Context, ref ir.SecretRef) error {
	client, err := r.getClient(ctx, ref)
	if err != nil {
		return err
	}
...
func (r *vaultResolver) getClient(ctx context.Context, ref ir.SecretRef) (vaultClient, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *vaultResolver) resolveClientSettings(ctx context.Context, ref ir.SecretRef) vaultClientSettings {
...
func (r *vaultResolver) parseKey(ref ir.SecretRef) (string, string) {

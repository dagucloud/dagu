...
var legacyToSnakeCaseKey = map[string]string{
	...
	"auth.oidc.rolemapping.workspacemappings":      "auth.oidc.role_mapping.workspace_mappings",
	"auth.oidc.rolemapping.defaultworkspaceaccess": "auth.oidc.role_mapping.default_workspace_access",

...
func TestListTreeSortNameAsc(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldName, Order: docs.DocSortOrderAsc})
	require.NoError(t, err)
...
func TestListTreeSortNameDesc(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldName, Order: docs.DocSortOrderDesc})
	require.NoError(t, err)
	require.Len(t, result.Items, 3)
...
func TestListTreeSortTypeAsc(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldType, Order: docs.DocSortOrderAsc})
	require.NoError(t, err)
	require.Len(t, result.Items, 3)
	// Directories first.
	assert.Equal(t, "directory", result.Items[0].Type)
...
func TestListTreeSortTypeDesc(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldType, Order: docs.DocSortOrderDesc})
	require.NoError(t, err)
	require.Len(t, result.Items, 3)
...
func TestListTreeSortMtimeAsc(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldMTime, Order: docs.DocSortOrderAsc})
	require.NoError(t, err)
	require.Len(t, result.Items, 3)
...
func TestListTreeSortDefaultsToTypeAsc(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50})
	require.NoError(t, err)
	require.Len(t, result.Items, 2)
	assert.Equal(t, "directory", result.Items[0].Type)
	assert.Equal(t, "file", result.Items[1].Type)
...
func TestListFlatSortNameDesc(t *testing.T) {
	...
	result, err := store.ListFlat(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldName, Order: docs.DocSortOrderDesc})
	require.NoError(t, err)
	require.Len(t, result.Items, 3)
	assert.Equal(t, "c-doc", result.Items[0].ID)
	assert.Equal(t, "b-doc", result.Items[1].ID)
...
func TestListFlatSortMtime(t *testing.T) {
	...
	result, err := store.ListFlat(ctx, docs.ListDocsOptions{Page: 1, PerPage: 50, Sort: docs.DocSortFieldMTime, Order: docs.DocSortOrderDesc})
	require.NoError(t, err)
	require.Len(t, result.Items, 2)
...
func TestListTreeSortMtimeKeepsDirectoriesAlphabetical(t *testing.T) {
	...
	result, err := store.List(ctx, docs.ListDocsOptions{
		Page:    1,
		PerPage: 50,
		Sort:    docs.DocSortFieldMTime,
		Order:   docs.DocSortOrderDesc,
	})
	require.NoError(t, err)
...
func TestListTreeSortPaginationConsistency(t *testing.T) {
	...
	opts := docs.ListDocsOptions{Page: 1, PerPage: 2, Sort: docs.DocSortFieldName, Order: docs.DocSortOrderDesc}

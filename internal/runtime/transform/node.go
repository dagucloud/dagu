...
func ToNodeWithStep(n *exec.Node, step core.Step) *runtime.Node {
	...
	return runtime.NewNode(step, runtime.NodeState{
		...
		HumanTaskPrompt:        n.HumanTaskPrompt,
		HumanTaskInput:         append([]byte(nil), n.HumanTaskInput...),
		HumanTaskCompletedAt:   n.HumanTaskCompletedAt,
...
func newNode(node runtime.NodeData) *exec.Node {
	...
	return &exec.Node{
		...
		HumanTaskPrompt:        node.State.HumanTaskPrompt,
		HumanTaskInput:         append([]byte(nil), node.State.HumanTaskInput...),
		HumanTaskCompletedAt:   node.State.HumanTaskCompletedAt,

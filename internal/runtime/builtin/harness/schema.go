...
var configSchema = &jsonschema.Schema{
	...
	Properties: map[string]*jsonschema.Schema{
		"provider": {Type: "string", Description: "Harness provider name. Use a built-in CLI provider (aider, amp, claude, cline, codex, copilot, cursor, deepseek, droid, gemini, goose, kilo, kiro, opencode, pi, or qwen) or a custom top-level harnesses entry."},
		"fallback": {
			Type: "array",

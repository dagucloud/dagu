...
func (m *Manager) GetCurrentStatus(ctx context.Context, dag *ir.DAG, dagRunID string) (*exec.DAGRunStatus, error) {
	if dagRunID == "" {
...
func (m *Manager) GetLatestStatus(ctx context.Context, dag *ir.DAG) (exec.DAGRunStatus, error) {

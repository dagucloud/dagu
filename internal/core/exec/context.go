...
func NewContext(
	...
	maps.Copy(envs, evaluateDAGEnvRuntime(ctx, dag, baseForDAGEnv, managedEnvs))
...
func evaluateDAGEnvRuntime(ctx context.Context, dag *core.DAG, base map[string]string, protected map[string]string) map[string]string {
	var envList []string

...
func (m *mockDAGStore) LoadSpecWithResult(_ context.Context, _ []byte, _ ...spec.LoadOption) (*spec.LoadResult, error) {
	return &spec.LoadResult{}, nil
}
...
func TestReadLegacyStatusFile(t *testing.T) {
	...
	assert.Equal(t, core.Succeeded, statusFile.Status.Status)

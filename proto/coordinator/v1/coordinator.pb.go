...
type ReportStatusRequest struct {
	...
	LivenessAttemptKey string `protobuf:"bytes,4,opt,name=liveness_attempt_key,json=livenessAttemptKey,proto3" json:"liveness_attempt_key,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (b0 ReportStatusRequest_builder) Build() *ReportStatusRequest {
	...
	x.Status = b.Status
	x.OwnerCoordinatorId = b.OwnerCoordinatorId
	x.LivenessAttemptKey = b.LivenessAttemptKey
	return m0
}

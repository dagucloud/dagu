...
type Task struct {
	...
	ChildRetryRoute string `protobuf:"bytes,33,opt,name=child_retry_route,json=childRetryRoute,proto3" json:"child_retry_route,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (b0 Task_builder) Build() *Task {
	...
	x.ChildRetryRoute = b.ChildRetryRoute
	return m0
}
